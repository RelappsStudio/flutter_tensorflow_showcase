...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const DigitClassificationScreen(),
    );
  }
}

class DigitClassificationScreen extends StatefulWidget {
  const DigitClassificationScreen({super.key});

  @override
  State<DigitClassificationScreen> createState() =>
      _DigitClassificationScreenState();
}

class _DigitClassificationScreenState extends State<DigitClassificationScreen> {
